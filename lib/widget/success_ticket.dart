...
import 'package:nexthour/utils/profile_tile.dart';

//  Container having details that is used in success dialog

class SuccessTicket extends StatelessWidget {
  SuccessTicket(
      this.msgResponse, this.subdate, this.name, this.time, this.index);
  final msgResponse;
  final subdate;
  final name;
  final time;
...
class SuccessTicket2 extends StatelessWidget {
  SuccessTicket2(this.msgResponse, this.subdate, this.name, this.time,
      this.currency, this.planAmount);
  final msgResponse;
  final subdate;
  final name;
  final time;
