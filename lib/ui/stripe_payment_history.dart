...
import 'package:nexthour/model/stripe_history_model.dart';
import 'package:nexthour/utils/seperator2.dart';
import 'package:nexthour/widget/blank_history.dart';
...
class StripePaymentHistoryState extends State<StripePaymentHistory> {
  ...
  List<StripeHistoryModel> _stripeHistoryList() {
    return List<StripeHistoryModel>.generate(
        userStripeHistory == null ? 0 : userStripeHistory.length, (int index) {
                          ...
                          Expanded(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                subscriptionFromTo(itemList1[j].subscriptionTo,
                                    itemList1[j].subscriptionTo),
                              ],
                            ),
                          ),
                        ],
