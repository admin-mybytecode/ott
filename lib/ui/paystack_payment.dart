...
import 'package:nexthour/ui/credit_card_widget.dart';
import 'package:nexthour/widget/paystack_paynow_button.dart';
...
//  App bar
  Widget appBar(){
    return AppBar(
      title: Text("Paystack Payment",style: TextStyle(fontSize: 16.0),),
      centerTitle: true,
      backgroundColor:
