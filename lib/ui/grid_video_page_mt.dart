...
import 'package:nexthour/ui/grid_video_container.dart';
              ...
              itemBuilder: (BuildContext context, int index1) {
                ...
                newVideosTM = List<VideoDataModel>.generate(
                  ...
                  if (type == "T") {
                    ...
                    iFrameURL =
                        videoLink == null ? null : videoLink['iframeurl'];
                    iReadyUrl =
                        videoLink == null ? null : videoLink['ready_url'];
...
//                  print(newVideosTM);
                ...
                tmList = List.generate(
                    newVideosTM == null ? 0 : newVideosTM.length, (mIndex) {
                  if (type == widget.type) {
